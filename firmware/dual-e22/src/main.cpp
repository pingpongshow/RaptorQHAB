...
// payload/common/radio.py SX1262Config. The 234.3 kHz bandwidth follows Carson's
...
// CRC-32 (IEEE 802.3), matching payload/common/protocol.py.
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("RaptorHAB Dual-900 firmware/gs-modem");
