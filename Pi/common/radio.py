...
class SX1262:
    ...
    def _configure_fsk(self):
        ...
        # Enable RX Boosted Gain for better sensitivity
        # Per SX1262 datasheet Section 9.6, Table 9-3:
        #   0x94 = Power Saving mode (default)
        #   0x96 = Rx Boosted mode (+0.5 to 0.8 dB better sensitivity)
        # Register 0x08AC (REG_RX_GAIN)
