...
class Config:
    ...
    tx_pause_sec: int = 2            # Pause between TX bursts (0 = continuous TX)
    telemetry_interval_packets: int = 5
    image_meta_interval_packets: int = 10
    ...
    # === Operational ===
    auto_capture_interval_sec: int = 30  # Auto capture image every 30 seconds
